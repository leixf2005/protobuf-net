...
//                {
//                    using (var subReader = ReadableBufferReader.Create(_available, Position))
//                    {
...
//            return Task.CompletedTask;
//        }
//        internal static unsafe T ReadLittleEndian<T>(ref DoubleBufferedReadableBuffer buffer) where T : struct
//        {
//            T val;
...
//        }
//        internal unsafe static string ReadString(ref DoubleBufferedReadableBuffer source, int len)
//        {
//            string s;
...
//        internal static (int value, int consumed) TryPeekVarintInt32(ref DoubleBufferedReadableBuffer buffer)
//        {
...
//            }
//        }
//        private static unsafe (int value, int consumed) TryPeekVarintMultiSpan(ref DoubleBufferedReadableBuffer buffer)
//        {
//            int value = 0;
...
//                _available = new DoubleBufferedReadableBuffer(_originalAsReceived);
//                _isReading = false;
...
//                _available = new DoubleBufferedReadableBuffer(_originalAsReceived).Slice(_available.Start);
